...
export default class StripeSubscriptionsController {
  ...
  public async checkout({ response, auth, params, session }: HttpContext) {
  ...
  public async success({ request, response, auth, session }: HttpContext) {
    try {
  ...
  public async portal({ response, auth }: HttpContext) {
