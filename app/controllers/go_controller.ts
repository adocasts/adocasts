...
export default class GoController {
  async postComment({ response, params, session }: HttpContext) {
  ...
  async lessonRequestComment({ response, params, session }: HttpContext) {
    const { id, commentId } = params
  ...
  async discussionComment({ response, params, session }: HttpContext) {
    const { id, commentId } = params
  ...
  async authReset({ response, session }: HttpContext) {
