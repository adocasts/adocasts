    ...
    <Card className="w-full max-w-md mx-auto shadow-xl">
      <CardHeader>
        ...
        <CardDescription>
          ...
          Need an account? <Link route="new_account.create" className="link">Sign up instead</Link>
        </CardDescription>
      </CardHeader>
...
Login.layout = (page: ReactElement<Data.SharedProps>) => <AuthLayout children={page} />
